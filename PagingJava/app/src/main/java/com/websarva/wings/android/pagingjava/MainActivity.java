package com.websarva.wings.android.pagingjava;
...
import com.websarva.wings.android.pagingjava.databinding.ActivityMainBinding;
import com.websarva.wings.android.pagingjava.ui.MainViewModel;
...
public class MainActivity extends AppCompatActivity {
	...
	private class PhoneComparator extends DiffUtil.ItemCallback<Phone> {
		...
		public boolean areContentsTheSame(@NonNull Phone oldItem, @NonNull Phone newItem) {
			return oldItem.id.equals(newItem.id) && oldItem.phoneNo.equals(newItem.phoneNo);
		}
	}
}
